...
- Mi **"Desafío333 Ethereum web3" consta de 3 huesos: * el lenguaje de programación Solidity de Ethereum, * el entorno web3, * proyectos web2-web3.**  
#  
...
- Noche (de 22 a 6 h). 
  ...
  **Tengo en cuenta:**  
- Quiero superar el "Desafío333 Ethereum web3" mordiendo huesos de Solidity, el entorno web3 y proyectos web2-web3.  
...
Para otras metas un desafío333 podría ser muy extenso, por ejemplo “Aprender los nombres y localizaciones de mares y océanos”. Aquí podrías necesitar solamente 52 mordidas (ejemplo). En este caso sería conveniente añadir algún hueso al desafío para lograr las 333 mordidas entre todas y tener un gran conocimiento. ¿Quizás añadir: + “crear una maqueta del mundo señalando mares y océanos” + “descubrir especies endémicas de cada mar y océano”?  
Pero si decides parar el desafío al conseguir tu objetivo primero con las 52 mordidas lo conviertes en un **Desafío333 "52 mordidas mares y océanos"**. Has aprovechado y seguido la lógica pero ¡solo has necesitado 52 mordidas! ¿Por qué no? ¡No puedes evitar ser tan eficiente y veloz😃! Más adelante podrías aumentar esa cantidad porque te haces mariner@!!!  
  
En cambio, si la meta es intrínseca al desafío, por ejemplo Desafío333 “Meditaciones Mindfulness”, todo fluye más sencillo y te unes apoyándote en el sistema para tener una META motivadora, en este caso morder 333 veces realizando Mindfulness. Cada persona adapta su desafío a sus deseos y necesidades.  
